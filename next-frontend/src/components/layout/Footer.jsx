            ...
            <motion.div variants={itemVariants} className="flex items-center space-x-4">
              {socialLinks.map((social) => {
                const getIconContent = (iconName) => {
                  switch (iconName) {
                    case 'facebook':
                      return <span className="text-white text-sm font-bold">f</span>;
                    case 'twitter':
                      return <span className="text-white text-sm font-bold">t</span>;
                    case 'instagram':
                      return <span className="text-white text-sm font-bold">i</span>;
                    case 'linkedin':
                      return <span className="text-white text-sm font-bold">in</span>;
                    default:
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 ${getIconColor(social.icon)}`}
                  >
                    {getIconContent(social.icon)}
                  </motion.a>
                );
              })}
            </motion.div>
